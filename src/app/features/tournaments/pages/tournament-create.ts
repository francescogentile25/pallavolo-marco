...
@Component({
  ...
  `,
  styles: `
    :host{display:block}main{width:min(100%,980px);padding:18px 16px calc(var(--bottom-nav-height) + 55px);margin:auto}.create-hero{position:relative;overflow:hidden;padding:28px 22px;color:white;border-radius:28px 28px 0 0;background:linear-gradient(90deg,rgb(4 39 61/.97),rgb(4 61 91/.72)),url('/assets/images/tournaments-hero.webp') center/cover}.eyebrow,.heading p{margin:0 0 6px;color:#7dd3fc;font-size:.68rem;font-weight:900;letter-spacing:.12em;text-transform:uppercase}h1{margin:0;font:900 clamp(2.2rem,10vw,4.5rem)/.88 var(--display-font);letter-spacing:-.06em}h1 span{color:#bae6fd}.intro{max-width:39rem;margin:14px 0 0;color:rgb(255 255 255/.75);font-size:.78rem;line-height:1.55}ol{display:flex;gap:9px;padding:0;margin:24px 0 0;list-style:none}ol li{display:flex;align-items:center;gap:6px}ol span{display:grid;width:32px;height:32px;place-items:center;border:2px solid rgb(255 255 255/.28);border-radius:50%;font-size:.68rem;font-weight:900}ol small{display:none}ol li.active span{color:#075985;border-color:#7dd3fc;background:#7dd3fc}form{display:grid}section{min-height:450px;padding:24px 18px;border:1px solid var(--color-border);border-top:0;border-radius:0 0 26px 26px;background:white}.heading{display:flex;align-items:center;justify-content:space-between;margin-bottom:24px}.heading p{color:var(--color-brand-strong)}.heading h2{margin:0;font:900 1.7rem/1 var(--display-font);letter-spacing:-.04em}.heading>i{display:grid;width:50px;height:50px;place-items:center;color:var(--color-brand-strong);border-radius:16px;background:var(--color-brand-soft);font-size:1.2rem}.grid{display:grid;gap:16px}.field{display:grid;align-content:start;gap:7px;min-width:0}.field label{font-size:.74rem;font-weight:850}.field b{color:var(--color-danger)}.field input,.field textarea{width:100%}.field small{color:var(--color-ink-muted);font-size:.64rem}.wide{grid-column:1/-1}.level{display:grid;grid-template-columns:1fr auto 1fr;align-items:end;gap:8px}.level>span{padding-bottom:15px}.segmented{display:inline-flex;width:fit-content;gap:3px;padding:4px;border:1px solid var(--color-border);border-radius:14px;background:var(--color-surface-muted)}.segmented button{padding:8px 18px;color:var(--color-ink-muted);border:0;border-radius:10px;background:transparent;font:inherit;font-size:.72rem;font-weight:850;cursor:pointer}.segmented button.selected{color:#075985;background:white;box-shadow:0 2px 8px rgb(8 48 73/.1)}.review{display:grid;gap:11px}.review article{display:grid;grid-template-columns:38px 1fr;gap:3px 11px;padding:15px;border:1px solid #dceaf1;border-radius:17px;background:#f8fcfe}.review i{display:grid;grid-row:1/4;width:38px;height:38px;place-items:center;color:#0284c7;border-radius:12px;background:#e0f2fe}.review span,.review small{color:var(--color-ink-muted);font-size:.64rem}.review strong{font-size:.82rem}.blank-message{display:flex;align-items:flex-start;gap:12px;padding:17px;margin-top:18px;color:#075985;border-radius:17px;background:#e0f2fe}.blank-message>i{font-size:1.35rem}.blank-message div{display:grid;gap:4px}.blank-message span{font-size:.7rem;line-height:1.5}.form-error{display:flex;align-items:center;gap:8px;padding:12px;margin:12px 0 0;color:var(--color-danger);border-radius:13px;background:var(--color-danger-soft);font-size:.74rem;font-weight:750}footer{display:flex;justify-content:space-between;gap:10px;padding:16px 0}.p-invalid{border-color:var(--color-danger)!important}button:focus-visible,input:focus-visible,textarea:focus-visible{outline:3px solid var(--color-focus);outline-offset:2px}
