...
import { CreateTournamentRequest, TournamentState } from '../models/tournament.model';
...
export const TournamentsStore = signalStore(
  ...
  withMethods((store, service = inject(TournamentsService), messages = inject(MessageService)) => {
    ...
    return {
      ...
      closeRegistrations: (id: string) => act(id, () => service.closeRegistrations(id), 'Iscrizioni chiuse', 'Il calendario iniziale è stato generato.'),
